      ...
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex justify-between items-center relative">
        ...
        >
          <div className="hidden lg:flex h-full pl-12 pb-2">
            ...
            <a className="navbar-link" href="#about" aria-label="About">
              About
            </a>
            <a className="navbar-link" href="#services" aria-label="Services">
              Services
            </a>
            <a className="navbar-link" href="#portfolio" aria-label="Portfolio">
              Portfolio
            </a>
            <a className="navbar-link" href="#contact" aria-label="Contact">
              Contact
            </a>
          </div>
        </motion.div>
